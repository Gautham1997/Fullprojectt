ss<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
...
<script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></scrpt>
...
{
   height: 800px;
   background-image: url("G:\New folder\frontend\src\main\webapp\images\b1.jpg");
