...
<div class="container">
    ...
    <div class="form-group">
      <label class="control-label col-sm-2" for="text">CategoryName:</label>
      <div class="col-sm-10">
    ...
    <div class="form-group">
       <label class="control-label col-sm-2" for="text">Product Name:</label> 
          <div class="col-sm-10">
            <form:input class="form-control" path="produtName"/>
          </div>
    </div><br>
      ...
      <div class="form-group"> 
       ...
       <div class="form-group"> 
         <label class="control-label col-sm-2" for="text">Product Description:</label> 
            <div class="col-sm-10"> 
               <form:input class="form-control" path="produtDesription"/>
            </div>
       </div><br>
